...
using SendGrid;
using PoemPost.Shared.Configuration.Email;
using PoemPost.Shared.Email;
using PoemPost.STS.Identity.Configuration;
using PoemPost.STS.Identity.Configuration.ApplicationParts;
using PoemPost.STS.Identity.Configuration.Constants;
using PoemPost.STS.Identity.Configuration.Interfaces;
using PoemPost.STS.Identity.Helpers.Localization;
using System.Linq;
using IdentityServer4;
using Microsoft.AspNetCore.Authentication.AzureAD.UI;
using Microsoft.AspNetCore.Authentication.OAuth;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using PoemPost.Admin.EntityFramework.MySql.Extensions;
using PoemPost.Admin.EntityFramework.PostgreSQL.Extensions;
using PoemPost.Admin.EntityFramework.Shared.Configuration;
using PoemPost.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using Microsoft.IdentityModel.Tokens;
using PoemPost.Shared.Authentication;
using PoemPost.Shared.Configuration.Identity;

namespace PoemPost.STS.Identity.Helpers
{
